...
def encode(filepath):
    ...
    if video_codec[0] == 'hevc':
        ...
        video_opts = '-map 0 -c:v libx265 -pix_fmt yuv420p -preset medium -tune animation -crf 32 -b:v 340k'
    ...
    if audio_codec == []:
        ...
        audio_opts = '-c:a libfdk_aac -profile:a aac_he_v2 -ac 2 -vbr 2 -ab 55k -c:s copy'
